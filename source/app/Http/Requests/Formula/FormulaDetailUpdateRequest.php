...
class FormulaDetailUpdateRequest extends BaseRequest
{
    /**
    ...
    public function rules(): array
    {
        ...
        return [
            ...
            'category_solds' => ['array'],
            'category_purchases' => ['array'],
            'category_purchases.*.id' => ['required', 'integer', 'exists:category_purchases,id'],
            'category_purchases.*.value_from' => ['required', 'numeric', 'min:0', 'max:100'],
            'category_purchases.*.value_to' => ['required', 'numeric', 'min:0', 'max:100'],
        ];
    }
}
