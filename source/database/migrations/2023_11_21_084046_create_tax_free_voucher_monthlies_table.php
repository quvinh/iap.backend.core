...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::create('tax_free_voucher_monthlies', function (Blueprint $table) {
            $table->id();
            $table->unsignedBigInteger('company_detail_tax_free_voucher_id');
            ...
            $table->foreign('company_detail_tax_free_voucher_id')->references('id')->on('company_detail_tax_free_vouchers');
        });
    }
