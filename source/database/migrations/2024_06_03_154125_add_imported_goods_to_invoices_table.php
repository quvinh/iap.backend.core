...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::table('invoices', function (Blueprint $table) {
            ...
            $table->string('icp_currency')->nullable()->after('is_imported_goods')->comment('international commondity prices');
            $table->decimal('icp_currency_price', 12, 2)->default(0)->after('icp_currency')->comment('international commondity prices');
